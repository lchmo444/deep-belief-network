...
class BinaryRBM(BaseEstimator, TransformerMixin, BaseModel):
    ...
    def __init__(self,
        ...
        self.patience_dbn = patience_dbn
        self.delta_rbm = delta_rbm
        self.delta_dbn = delta_dbn
    ...
    def fit(self, X, y=None):
        ...
        for n_hidden_units in self.hidden_layers_structure:
            rbm = self.rbm_class(n_hidden_units=n_hidden_units,
                                 ...
                                 patience_rbm=self.patience_rbm,
                                 patience_dbn=self.patience_dbn,
                                 delta_rbm=self.delta_rbm,
                                 delta_dbn=self.delta_dbn)
